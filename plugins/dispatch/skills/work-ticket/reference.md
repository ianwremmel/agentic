...
| Review artifact | Where a milestone review lives on this tracker: the venue bound to a milestone (or its project) that records the review outcome and carries its comment thread, with the find/post bindings for both. Read only by `milestone-review`; required only for a tracker whose milestones are review-gated.                                                                                                                                                                                    |
